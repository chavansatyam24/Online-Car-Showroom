			...
			<div class="new-product">
				<div class="new-product-top">
					<ul class="product-top-list">
						...
						<li><span class="act">Hyundai Elantra</span>&nbsp;</li>
					</ul>
				     ...
				     <ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="images/model.png" class="img-responsive" />
									<img class="etalage_source_image" src="images/model.png" class="img-responsive" />
								</a>
							</li>
				...
				<div class="cont1 span_2_of_al">
					...
					<div class="price_single">
					  <span class="actual">₹1250000</span>
					  <a href="#">click for offer</a>
					</div>
					<h2 class="quick">Quick Overview:</h2>
					<p class="quick_desc"> Hyundai India has launched the Elantra at Rs ₹1250000.
                    <br>Fuel Type - Petrol</br>
					<br>City/Highway Mileage - 11.7kmpl/13.2kmpl0</br>
                    <br> Engine Displacement - 1190 cc</br>
                    <br>BHP	- 82.8bhp@6000rpm</br>
                    <br>Torque - 100Nm@5200rpm</br>
