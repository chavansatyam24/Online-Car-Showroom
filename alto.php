			...
			<div class="new-product">
				<div class="new-product-top">
					<ul class="product-top-list">
						...
						<li><span class="act">Maruti Suzuki Alto </span>&nbsp;</li>
					</ul>
				     ...
				     <ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="images/alto1.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="images/alto1.jpg" class="img-responsive" />
								</a>
							</li>
				...
				<div class="cont1 span_2_of_al">
					...
					<div class="price_single">
					  <span class="actual">₹500000</span>
					  <a href="#">click for offer</a>
					</div>
					<h2 class="quick">Quick Overview:</h2>
					<p class="quick_desc"> Maruti Suzuki India has launched the Alto at Rs ₹500000.
                    <br>Fuel Type - Petrol,Diesel</br>
					<br>City/Highway Mileage - 10.7kmpl/13.2kmpl0</br>
                    <br> Engine Displacement - 1180 cc</br>
                    <br>BHP	- 79.8bhp@5100rpm</br>
                    <br>Torque - 100Nm@4900rpm</br>
