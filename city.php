			...
			<div class="new-product">
				<div class="new-product-top">
					<ul class="product-top-list">
						...
						<li><span class="act">Honda City</span>&nbsp;</li>
					</ul>
				     ...
				     <ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="images/city.png" class="img-responsive" />
									<img class="etalage_source_image" src="images/city.png" class="img-responsive" />
								</a>
							</li>
				...
				<div class="cont1 span_2_of_al">
					...
					<div class="price_single">
					  <span class="actual">₹1200000</span>
					  <a href="#">click for offer</a>
					</div>
					<h2 class="quick">Quick Overview:</h2>
					<p class="quick_desc"> Honda India has finally launched the City at Rs ₹1200000.
                    <br>Fuel Type - Petrol,Diesel</br>
					<br>City/Highway Mileage - 14.2kmpl/15.5kmpl0</br>
                    <br> Engine Displacement - 1290 cc</br>
                    <br>BHP	- 90.4bhp@7100rpm</br>
                    <br>Torque - 125Nm@5900rpm</br>
