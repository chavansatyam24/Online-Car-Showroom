			...
			<div class="new-product">
				<div class="new-product-top">
					<ul class="product-top-list">
						...
						<li><span class="act">Honda Accord</span>&nbsp;</li>
					</ul>
				     ...
				     <ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="images/accord.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="images/accord.jpg" class="img-responsive" />
								</a>
							</li>
				...
				<div class="cont1 span_2_of_al">
					...
					<div class="price_single">
					  <span class="actual">₹1500000</span>
					  <h2 class="quick">Quick Overview:</h2>
					  <a href="#">click for offer</a>
					</div>
					<h2 class="quick">Quick Overview:</h2>
					<p class="quick_desc"> Honda India has launched the Accord at Rs ₹1500000.
                    <br>Fuel Type - Diesel</br>
					<br>City/Highway Mileage - 16.1kmpl/18.2kmpl0</br>
                    <br> Engine Displacement - 1102 cc</br>
                    <br>BHP	- 90.8bhp@6400rpm</br>
                    <br>Torque - 119Nm@4900rpm</br>
					</p>
				</div>
				<div class="clearfix"></div>
			</div>
