                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover"
                                        ...
                                        <tbody>
                                            ...
                                            $q = mysqli_query($conn, $sql); // Add $connection as the first argument
                                            ...
                                            if (mysqli_num_rows($q) > 0) {
                                                while ($r = mysqli_fetch_array($q)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="center">
                                                            <a href="viewenquiry.php?id=<?php echo $r['eid']; ?>"
                                                                class="myasimple" title="Edit">
                                                                view
                                                            </a>
                                                            &nbsp;
                                                            <a onclick="return confirm('Are you sure you want to delete this record');"
                                                                href="enquiry.php?id=<?php echo $r['eid']; ?>&action=delete"
                                                                class="myasimple" title="Delete">
