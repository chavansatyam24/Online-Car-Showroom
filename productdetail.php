...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO enquiry (name, contactno, emailid, message, pid, isread) VALUES (?, ?, ?, ?, ?, 'Unread')";
    $stmt = mysqli_prepare($conn, $sql);

    if ($stmt) {
        // Bind parameters
        mysqli_stmt_bind_param($stmt, "ssssi", $name, $contactno, $emailid, $message, $pid);
				     ...
				     <ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="upload/<?php echo $r['image'];?>" class="img-responsive" />
									<img class="etalage_source_image" src="upload/<?php echo $r['image'];?>" class="img-responsive" />
								</a>
							</li>
...
<tr><td>Contact :</td><td><input type="text" name="contactno"><br><br>
<tr><td>Email:</td><td><input type="text" name="emailid" ><br><br></td></tr>
<tr><td>Message:</td><td><textarea rows="3" cols="22" name="message"></textarea><br><br></td></tr>
<input type="hidden" value="<?php echo $r['id'];?>" name="pid" >
<br><br></td></tr>
</table>
<input type="submit" name="submit" value="Send Enqury" class="button"><br><br>
	  </form>
