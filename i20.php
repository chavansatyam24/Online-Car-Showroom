			...
			<div class="new-product">
				<div class="new-product-top">
					<ul class="product-top-list">
						...
						<li><span class="act">Hyundai I20</span>&nbsp;</li>
					</ul>
				     ...
				     <ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="images/i20.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="images/i20.jpg" class="img-responsive" />
								</a>
							</li>
				...
				<div class="cont1 span_2_of_al">
					...
					<p class="quick_desc"> Hyundai India has launched the I20 at Rs ₹800000.
                    <br>Fuel Type - Petrol,Diesel</br>
					<br>City/Highway Mileage - 15.7kmpl/18.7kmpl0</br>
                    <br> Engine Displacement - 1300 cc</br>
                    <br>BHP	- 89.1bhp@7500rpm</br>
                    <br>Torque - 140Nm@6500rpm</br>
