			...
			<div class="new-product">
				<div class="new-product-top">
					<ul class="product-top-list">
						...
						<li><span class="act">Honda Amaze</span>&nbsp;</li>
					</ul>
				     ...
				     <ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="images/-amaze.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="images/-amaze.jpg" class="img-responsive" />
								</a>
							</li>
				...
				<div class="cont1 span_2_of_al">
					...
					<div class="price_single">
					  <span class="actual">₹800000</span>
					  <!---<a href="#">click for offer</a><--->
					</div>
					<h2 class="quick">Quick Overview:</h2>
					<p class="quick_desc"> Honda India has finally launched the Amaze at Rs ₹800000.
                    <br>Fuel Type - Petrol,Diesel</br>
					<br>City/Highway Mileage - 18.7kmpl/20.5kmpl0</br>
                    <br> Engine Displacement - 1210 cc</br>
                    <br>BHP	- 88.8bhp@7000rpm</br>
                    <br>Torque - 105Nm@5500rpm</br>
