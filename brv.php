			...
			<div class="new-product">
				<div class="new-product-top">
					<ul class="product-top-list">
						...
						<li><span class="act">Honda B-RV</span>&nbsp;</li>
					</ul>
				     ...
				     <ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="images/brv.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="images/brv.jpg" class="img-responsive" />
								</a>
							</li>
				...
				<div class="cont1 span_2_of_al">
					...
					<div class="price_single">
					  <span class="actual">₹1600000</span>
					  <a href="#">click for offer</a>
					</div>
					<h2 class="quick">Quick Overview:</h2>
					<p class="quick_desc"> Honda India has finally launched the B-RV at Rs ₹1600000.
                    <br>Fuel Type - Petrol</br>
					<br>City/Highway Mileage - 13.7kmpl/15.9kmpl0</br>
                    <br> Engine Displacement - 1540 cc</br>
                    <br>BHP	- 95.8bhp@8000rpm</br>
                    <br>Torque - 156Nm@6000rpm</br>
